...
jq -cS '
  ...
  def v110:
    .scope == "protected-release" and
    .releaseId == 368531227 and .tag == "v1.1.0" and .version == "1.1.0" and
    .releaseSourceDigest == "36ffd11ea4d35147f1df9c1cafa6a330300c1339" and
    .rootDigest == "sha256:c156a8a1436b008eea2980711b233b6f800cf60a36cdbe08faf480a2c97e6570" and
    .certificateSourceDigest == "8598a31e60d0bae784bebf43404f3b1e91d603e1" and
    .signerDigest == "8598a31e60d0bae784bebf43404f3b1e91d603e1" and
    .signerWorkflow == ".github/workflows/release-please.yml" and
    .subject.name == "ghcr.io/nickolaymamonov/meet-backend-v3" and
    .evidenceStorage == {kind:"oci-registry-bundle"};
  def v120:
  ...
  def v130:
    .scope == "protected-release" and
    .releaseId == 377201468 and .tag == "v1.3.0" and .version == "1.3.0" and
    .releaseSourceDigest == "a7abfe04f6852f479291a4710ebdee23e9ae8a34" and
    .rootDigest == "sha256:88b697872331ed2786f2d9009c769a87c32470086702faacf9874576fe094e9e" and
    .certificateSourceDigest == "79263bfed6427dc1a45900e338805c52dbd5f59d" and
    .signerDigest == "79263bfed6427dc1a45900e338805c52dbd5f59d" and
    .signerWorkflow == ".github/workflows/release-please.yml" and
    .subject.name == "image-index.json" and
    .evidenceStorage == {
      kind:"github-api-workflow-artifact",
      bundleDigest:"sha256:cb48b0ad1cf2a02733057e337bbba3ea4dc493c311f95117afb3381f894e19a8",
      asset:expected_v130_assets[1],assets:expected_v130_assets
    };
  def candidate:
    ...
    .subject.name == "ghcr.io/nickolaymamonov/meet-backend-v3" and
    .evidenceStorage == {kind:"oci-registry-bundle"};
  if type == "object" and common and (v101 or v110 or v120 or v130 or candidate)
...
if [ "$kind" = github-api-workflow-artifact ]; then
  ...
  jq -e --slurpfile authority "$authority" '
    ($authority[0]) as $a |
    type == "object" and
    .repository == $a.repository and
    .tag == $a.tag and .releaseId == $a.releaseId and
    .sourceSha == $a.releaseSourceDigest and
