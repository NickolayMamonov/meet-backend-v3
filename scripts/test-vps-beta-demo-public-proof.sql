...
expected_meetings(
    ...
    VALUES
        ('closed-beta-demo/meeting/welcome', 1::bigint, 'https://api.whysoezzy.online/demo-assets/v1/meeting-moscow.png', '[ДЕМО] Знакомство с клубом', 'Демонстрационная встреча для знакомства с приложением и участниками закрытой беты.', 1821456000000::bigint, '20.09.2027', 'Москва, Тверская улица, 13', 55.7647::double precision, 37.6054::double precision, 40, NULL::text, false, 'closed-beta-demo/user/01', 'closed-beta-demo/community/moscow-meets', ARRAY['closed-beta-demo/tag/networking','closed-beta-demo/tag/organizing'], ARRAY['closed-beta-demo/user/02','closed-beta-demo/user/03','closed-beta-demo/user/06']),
        ('closed-beta-demo/meeting/organize-online', 2::bigint, 'https://api.whysoezzy.online/demo-assets/v1/meeting-online.png', '[ДЕМО] Как организовать онлайн-встречу', 'Демонстрационный разбор подготовки понятной и безопасной онлайн-встречи.', 1821718800000::bigint, '23.09.2027', 'Онлайн', 55.7558::double precision, 37.6176::double precision, 100, 'https://api.whysoezzy.online/demo-events/organize-online', true, 'closed-beta-demo/user/05', 'closed-beta-demo/community/online-club', ARRAY['closed-beta-demo/tag/online','closed-beta-demo/tag/organizing'], ARRAY['closed-beta-demo/user/01','closed-beta-demo/user/03','closed-beta-demo/user/06']),
        ('closed-beta-demo/meeting/board-games', 3::bigint, 'https://api.whysoezzy.online/demo-assets/v1/meeting-moscow.png', '[ДЕМО] Вечер настольных игр', 'Демонстрационный игровой вечер для небольшой компании и проверки записи на встречу.', 1822062600000::bigint, '27.09.2027', 'Москва, улица Новый Арбат, 21', 55.7522::double precision, 37.5866::double precision, 36, NULL::text, false, 'closed-beta-demo/user/04', 'closed-beta-demo/community/moscow-meets', ARRAY['closed-beta-demo/tag/board-games','closed-beta-demo/tag/networking'], ARRAY['closed-beta-demo/user/02','closed-beta-demo/user/05','closed-beta-demo/user/06']),
        ('closed-beta-demo/meeting/vdnkh-walk', 4::bigint, 'https://api.whysoezzy.online/demo-assets/v1/meeting-moscow.png', '[ДЕМО] Прогулка по ВДНХ', 'Демонстрационная прогулка по ВДНХ с понятной точкой сбора и ограниченной группой.', 1822636800000::bigint, '04.10.2027', 'Москва, проспект Мира, 119', 55.8298::double precision, 37.6339::double precision, 30, NULL::text, false, 'closed-beta-demo/user/02', 'closed-beta-demo/community/city-walks', ARRAY['closed-beta-demo/tag/networking','closed-beta-demo/tag/walks'], ARRAY['closed-beta-demo/user/01','closed-beta-demo/user/04','closed-beta-demo/user/06']),
        ('closed-beta-demo/meeting/networking-online', 5::bigint, 'https://api.whysoezzy.online/demo-assets/v1/meeting-online.png', '[ДЕМО] Нетворкинг без неловкости', 'Демонстрационная онлайн-встреча с короткими знакомствами и безопасным публичным описанием.', 1822928400000::bigint, '07.10.2027', 'Онлайн', 55.7558::double precision, 37.6176::double precision, 100, 'https://api.whysoezzy.online/demo-events/networking-online', true, 'closed-beta-demo/user/03', 'closed-beta-demo/community/online-club', ARRAY['closed-beta-demo/tag/networking','closed-beta-demo/tag/online'], ARRAY['closed-beta-demo/user/01','closed-beta-demo/user/02','closed-beta-demo/user/05']),
        ('closed-beta-demo/meeting/public-speaking', 6::bigint, 'https://api.whysoezzy.online/demo-assets/v1/meeting-moscow.png', '[ДЕМО] Практикум по публичным выступлениям', 'Демонстрационный практикум с короткими выступлениями и бережной обратной связью.', 1823443200000::bigint, '13.10.2027', 'Москва, улица Покровка, 47', 55.7641::double precision, 37.6527::double precision, 50, NULL::text, false, 'closed-beta-demo/user/03', 'closed-beta-demo/community/moscow-meets', ARRAY['closed-beta-demo/tag/networking','closed-beta-demo/tag/public-speaking'], ARRAY['closed-beta-demo/user/01','closed-beta-demo/user/04','closed-beta-demo/user/06'])
),
