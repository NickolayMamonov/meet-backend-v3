...
class PushReminderMigrationPostgresTest : IntegrationTestSupport() {
    ...
    @Test
    fun `push reminder migrations create push tables and meeting start version trigger`() {
        val fixture = fixture()
    ...
    @Test
    fun `V11 adds all-row owner index for lookup and user deletion cascade`() {
        val fixture = fixture()
